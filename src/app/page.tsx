      ...
      <div className="mt-8 flex grow flex-col gap-4 md:flex-row justify-center">
        <div className="flex flex-col justify-center items-center gap-6 w-full bg-gray-800 rounded-2xl shadow-xl border border-gray-700 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-6">
            <Link
              href="/login"
              className="px-6 py-3 rounded-lg bg-indigo-600 text-white font-semibold text-lg hover:bg-indigo-700 transition"
            >
              Login
            </Link>
            <Link
              href="/signup"
              className="px-6 py-3 rounded-lg border border-gray-300 text-gray-100 font-semibold text-lg hover:bg-gray-700 transition"
            >
              Sign Up
            </Link>
          </div>
